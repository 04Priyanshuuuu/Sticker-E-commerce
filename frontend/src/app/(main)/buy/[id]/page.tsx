  ...
  useEffect(() => {
    ...
    const fetchSticker = async () => {
      try {
        ...
        setRelated(
          relatedData.filter((s: any) => s.id !== data.id)
        );
      } catch (err) {
        console.error(err);
      }
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="bg-gray-700 px-3 py-1 rounded text-lg cursor-pointer"
            >
              −
            </button>
          ...
          <div className="flex gap-4 mt-4">
            ...
            <button
              ...
              className="bg-green-600 hover:bg-green-700 text-white px-5 py-2 rounded-lg cursor-pointer transition"
            >
              Proceed to Checkout
            </button>
